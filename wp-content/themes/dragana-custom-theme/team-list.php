...
<?php  
if( have_rows('flexible_content_team_list', 'option') ): 
    while ( have_rows('flexible_content_team_list', 'option') ) : the_row(); 
        if(get_row_layout() == 'team_list_layout'): 
?>
    ...
    <div class="team-list">
        <div class="container">
            ...
            <?php  
            if( have_rows('team_list_post_obj', 'option') ): 
                while ( have_rows('team_list_post_obj', 'option') ) : the_row(); 
                    if(get_row_layout() == 'single_team_layout'): 
            ?>
